...
varport <- serial.test(resvar2, lags.pt = 16, type = "PT.asymptotic")
varport
...
y1 <- matrix(c(0.605,0,0.00094,0.68), nrow = 2)
linv%*%y1
y8 <- matrix(c(0.065,0,0,-0.105), nrow = 2)
linv%*%y8
...
y1 <- matrix(c(0.68,0.00094,0,0.605), nrow = 2)
linv%*%y1
y8 <- matrix(c(0.065,0,0,-0.105), nrow = 2)
linv%*%y8
